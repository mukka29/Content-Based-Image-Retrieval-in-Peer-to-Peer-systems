...
<html>
    ...
    <body>
        <%
            ...
            int up = st.executeUpdate("update imagupload set imagename ='" + imagename + "',imgsubname='"+imgsubname+"',imagcate='"+imagcate+"',color='"+color+"',description='"+description+"' where id = '" + id+ "'");
            if (up != 0) {
